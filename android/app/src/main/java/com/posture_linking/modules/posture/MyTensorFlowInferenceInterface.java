 ...
 * example usage.
 */
public class MyTensorFlowInferenceInterface {
  private static final String TAG = "MyTensorFlowInferenceInterface";

  public MyTensorFlowInferenceInterface(String model) {
